...
//start
var friends_Names = ["Waqar", "Ahmed", "Ans"];
for (var n = 0; n < friends_Names.length; n++) {
...
//start
var friends = ["Waqar", "Ahmed", "Ans"];
for (var n = 0; n < friends_Names.length; n++) {
    console.log("Hello ".concat(friends_Names[n]));
}
var friend = ["Waqar", "Ahmed", "Ans"];
for (var i in friend) {
    console.log("Hi! ".concat(friend[i]));
}
//end
...
//start
var veh = ["bick", "cysle", "car"];
veh.forEach(function (items) {
    console.log("I would like to own a Honda ".concat(items));
});
//end
...
//start
var guest = ["Ali", "hamza", "Bakhtawar"];
guest.forEach(function (guest) {
    console.log("hello ".concat(guest, " I am inviting you to attend my sister wedding."));
});
//end
...
//start
var oldguestlist = ["Ali", "Hmaza", "Bakhtawar"];
var Notcome = "Bakhtawar";
var invite = "Noor";
console.log("".concat(Notcome, " is not attending the wedding"));
for (var i in oldguestlist) {
    if (oldguestlist[i] === Notcome) {
        oldguestlist[i] = invite;
    }
    ;
    console.log("".concat(oldguestlist[i], " you are invited to my sister wedding!"));
}
var newlist = oldguestlist.map(function (guest) { return guest === Notcome ? invite : guest; });
newlist.forEach(function (guest) {
    console.log(guest);
});
//end
...
lista.map(function (list) {
    console.log("To gather ".concat(list, " all are in the same table"));
});
//end
...
while (lista.length > 2) {
    var removeGuest = lista.pop();
    console.log("".concat(removeGuest, " you\u2019re sorry you can\u2019t invite them to dinner"));
}
...
var countries = ["Pakistan", "Australia", "Turkey", "UAE"];
